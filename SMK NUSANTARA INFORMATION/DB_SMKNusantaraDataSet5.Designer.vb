...
<Global.System.Serializable(),  _
 ...
 Global.System.Xml.Serialization.XmlRootAttribute("DB_SMKNusantaraDataSet5"),  _
 Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.DataSet")>  _
Partial Public Class DB_SMKNusantaraDataSet5
    ...
    Public Overrides Function Clone() As Global.System.Data.DataSet
        Dim cln As DB_SMKNusantaraDataSet5 = CType(MyBase.Clone,DB_SMKNusantaraDataSet5)
        cln.InitVars
    ...
    Private Sub InitClass()
        Me.DataSetName = "DB_SMKNusantaraDataSet5"
        Me.Prefix = ""
        Me.Namespace = "http://tempuri.org/DB_SMKNusantaraDataSet5.xsd"
    ...
    Public Shared Function GetTypedDataSetSchema(ByVal xs As Global.System.Xml.Schema.XmlSchemaSet) As Global.System.Xml.Schema.XmlSchemaComplexType
        Dim ds As DB_SMKNusantaraDataSet5 = New DB_SMKNusantaraDataSet5()
    ...
    Partial Public Class msmemberDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")>  _
        Public Overloads Function AddmsmemberRow(ByVal memberid As String, ByVal name As String, ByVal email As String, ByVal joindate As Date) As msmemberRow
            Dim rowmsmemberRow As msmemberRow = CType(Me.NewRow,msmemberRow)
            Dim columnValuesArray() As Object = New Object() {memberid, name, email, joindate}
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")>  _
        Public Function FindBymemberid(ByVal memberid As String) As msmemberRow
    ...
    Partial Public Class msmemberRow
        ...
        Public Property memberid() As String
            Get
                Return CType(Me(Me.tablemsmember.memberidColumn),String)
            End Get
            Set
...
Namespace DB_SMKNusantaraDataSet5TableAdapters
    ...
    Partial Public Class msmemberTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[msmember] WHERE (([memberid] = @Original_memberid) AND ((@IsNu"& _ 
                ...
                "l = 1 AND [email] IS NULL) OR ([email] = @Original_email)) AND ((@IsNull_joindat"& _ 
                "e = 1 AND [joindate] IS NULL) OR ([joindate] = @Original_joindate)))"
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[msmember] ([memberid], [name], [email], [joindate]) VALUES (@m"& _ 
                "emberid, @name, @email, @joindate);"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT memberid, name, email, joindate FROM"& _ 
                " msmember WHERE (memberid = @memberid)"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[msmember] SET [memberid] = @memberid, [name] = @name, [email] = @em"& _ 
                "ail, [joindate] = @joindate WHERE (([memberid] = @Original_memberid) AND ((@IsNu"& _ 
                "ll_name = 1 AND [name] IS NULL) OR ([name] = @Original_name)) AND ((@IsNull_emai"& _ 
                "l = 1 AND [email] IS NULL) OR ([email] = @Original_email)) AND ((@IsNull_joindat"& _ 
                "e = 1 AND [joindate] IS NULL) OR ([joindate] = @Original_joindate)));"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT me"& _ 
                "mberid, name, email, joindate FROM msmember WHERE (memberid = @memberid)"
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT memberid, name, email, joindate FROM dbo.msmember"
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As DB_SMKNusantaraDataSet5.msmemberDataTable) As Integer
        ...
        Public Overloads Overridable Function GetData() As DB_SMKNusantaraDataSet5.msmemberDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As DB_SMKNusantaraDataSet5.msmemberDataTable = New DB_SMKNusantaraDataSet5.msmemberDataTable()
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As DB_SMKNusantaraDataSet5.msmemberDataTable) As Integer
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataSet As DB_SMKNusantaraDataSet5) As Integer
        ...
        Public Overloads Overridable Function Delete(ByVal Original_memberid As String, ByVal Original_name As String, ByVal Original_email As String, ByVal Original_joindate As Global.System.Nullable(Of Date)) As Integer
        ...
        Public Overloads Overridable Function Insert(ByVal memberid As String, ByVal name As String, ByVal email As String, ByVal joindate As Global.System.Nullable(Of Date)) As Integer
        ...
        Public Overloads Overridable Function Update(ByVal memberid As String, ByVal name As String, ByVal email As String, ByVal joindate As Global.System.Nullable(Of Date), ByVal Original_memberid As String, ByVal Original_name As String, ByVal Original_email As String, ByVal Original_joindate As Global.System.Nullable(Of Date)) As Integer
            If (memberid Is Nothing) Then
                Throw New Global.System.ArgumentNullException("memberid")
            Else
            ...
            If (Original_memberid Is Nothing) Then
                Throw New Global.System.ArgumentNullException("Original_memberid")
            Else
                Me.Adapter.UpdateCommand.Parameters(4).Value = CType(Original_memberid,String)
            End If
            If (Original_name Is Nothing) Then
            ...
            If (Original_joindate.HasValue = true) Then
                ...
                Me.Adapter.UpdateCommand.Parameters(10).Value = CType(Original_joindate.Value,Date)
            Else
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Overloads Overridable Function Update(ByVal name As String, ByVal email As String, ByVal joindate As Global.System.Nullable(Of Date), ByVal Original_memberid As String, ByVal Original_name As String, ByVal Original_email As String, ByVal Original_joindate As Global.System.Nullable(Of Date)) As Integer
            Return Me.Update(Original_memberid, name, email, joindate, Original_memberid, Original_name, Original_email, Original_joindate)
        End Function
    End Class
    ...
    Partial Public Class TableAdapterManager
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")>  _
        Private Function UpdateUpdatedRows(ByVal dataSet As DB_SMKNusantaraDataSet5, ByVal allChangedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow), ByVal allAddedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")>  _
        Private Function UpdateInsertedRows(ByVal dataSet As DB_SMKNusantaraDataSet5, ByVal allAddedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
            Dim result As Integer = 0
            If (Not (Me._msmemberTableAdapter) Is Nothing) Then
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")>  _
        Private Function UpdateDeletedRows(ByVal dataSet As DB_SMKNusantaraDataSet5, ByVal allChangedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
            Dim result As Integer = 0
            If (Not (Me._msmemberTableAdapter) Is Nothing) Then
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")>  _
        Public Overridable Function UpdateAll(ByVal dataSet As DB_SMKNusantaraDataSet5) As Integer
